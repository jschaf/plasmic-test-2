...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: 38Ng4LmREJKeq8/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__y1HFl)}
      >
        <div className={classNames(defaultcss.all, sty.box__v6H49)}>
          <div className={classNames(defaultcss.all, sty.box__qt2N)}>
            {p.renderPlasmicSlot({
