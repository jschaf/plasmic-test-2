...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: N1ADvVcjlpqHDk/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: 2iw56pIpxVtnSI/icon
import profilepicNjZoaiXNwJ0T from "./images/profilepic.png"; // plasmic-import: njZOAI-x-nwJ0t/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__vwrSb)}
      >
        <div
