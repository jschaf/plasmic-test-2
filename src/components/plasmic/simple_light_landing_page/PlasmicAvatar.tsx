...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: 9IGjxfHXuxo97u/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__iIWb)}
            role={"img"}
