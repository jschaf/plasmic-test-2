...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: 8NaGRgoCRhgmS/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: bQNqaSHMb7ZLbl/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__njhd)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xBVce)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__utqhK)}>
          <SphereIcon
