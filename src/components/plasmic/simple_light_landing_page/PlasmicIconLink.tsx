...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: WALH0HCV03vDN/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__ek8Px)}
              role={"img"}
            />
          ),
