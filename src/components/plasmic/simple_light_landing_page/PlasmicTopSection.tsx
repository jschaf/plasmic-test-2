...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: bPmiYnqXAlKLE/css

import heroImage5Iz2Jgv0F3V9Gp from "./images/heroImage.png"; // plasmic-import: 5IZ2jgv0f3v9Gp/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__z79Zr)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___4EQe)}
        >
          <div className={classNames(defaultcss.all, sty.box___7D7Ot)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__tbMyc)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__vdbrw)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__gVq66)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__wpdbo)}>
          <img
